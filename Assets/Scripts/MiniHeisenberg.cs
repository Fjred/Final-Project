...
public class MiniHeisenberg : MonoBehaviour
{
    ...
    void Drop()
    {
        ...
        currentItem.transform.localScale = new Vector3(0.08f, 0.08f, 0.08f);
    ...
    void Equip()
    {
        if (!isPickedUp && currentItem == null)
        {
            ...
            item.transform.localScale = new Vector3(0.08f, 0.08f, 0.08f);
